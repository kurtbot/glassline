...
use crate::builtins::{
    ...
    extra_usage_utilization, fable_weekly_usage, free_memory, git_ahead_behind, git_branch,
    git_changes, git_ci_status, git_clean_status, git_conflicts, git_deletions, git_insertions,
    git_is_fork, git_origin_owner, git_origin_owner_repo, git_origin_repo, git_pr, git_root_dir,
    git_sha, git_staged, git_staged_files, git_status, git_unstaged, git_unstaged_files,
    git_untracked, git_untracked_files, git_upstream_owner, git_upstream_owner_repo,
    git_upstream_repo, git_worktree, git_worktree_branch, git_worktree_mode, git_worktree_name,
    ...
    session_clock, session_cost, session_name, skills, speed, terminal_width, thinking_effort,
    tokens_cached, tokens_input, tokens_output, tokens_total, usage, version,
};
